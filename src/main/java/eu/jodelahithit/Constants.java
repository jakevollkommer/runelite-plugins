...
public class Constants {
    ...
    static final Set<Integer> WOODCUTTING_ANIMATIONS = ImmutableSet.of(
            ...
            WOODCUTTING_2H_CRYSTAL_INACTIVE,
            WOODCUTTING_2H_3A,
            WOODCUTTING_ENT_BRONZE,
            WOODCUTTING_ENT_IRON,
            WOODCUTTING_ENT_STEEL,
            WOODCUTTING_ENT_BLACK,
            WOODCUTTING_ENT_MITHRIL,
            WOODCUTTING_ENT_ADAMANT,
            WOODCUTTING_ENT_RUNE,
            WOODCUTTING_ENT_GILDED,
            WOODCUTTING_ENT_DRAGON,
            WOODCUTTING_ENT_DRAGON_OR,
            WOODCUTTING_ENT_INFERNAL,
            WOODCUTTING_ENT_INFERNAL_OR,
            WOODCUTTING_ENT_3A,
            WOODCUTTING_ENT_CRYSTAL,
            WOODCUTTING_ENT_CRYSTAL_INACTIVE,
            WOODCUTTING_ENT_TRAILBLAZER,
            WOODCUTTING_ENT_2H_BRONZE,
            WOODCUTTING_ENT_2H_IRON,
            WOODCUTTING_ENT_2H_STEEL,
            WOODCUTTING_ENT_2H_BLACK,
            WOODCUTTING_ENT_2H_MITHRIL,
            WOODCUTTING_ENT_2H_ADAMANT,
            WOODCUTTING_ENT_2H_RUNE,
            WOODCUTTING_ENT_2H_DRAGON,
            WOODCUTTING_ENT_2H_CRYSTAL,
            WOODCUTTING_ENT_2H_CRYSTAL_INACTIVE,
            WOODCUTTING_ENT_2H_3A
    );
